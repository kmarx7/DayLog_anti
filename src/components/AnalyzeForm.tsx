      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-white/[0.08] bg-white/[0.02] py-3 pl-4 pr-4 text-sm text-white placeholder-slate-600 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500 transition duration-150"
            />
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-xl border border-white/[0.08] bg-white/[0.02] py-3 px-4 text-sm text-white placeholder-slate-600 focus:border-violet-500 focus:outline-none focus:ring-1 focus:ring-violet-500 resize-none transition duration-150"
          />
        </div>

        {/* Error Alert */}
        {errorMsg && (
          <div className="flex items-start gap-2.5 rounded-xl border border-red-500/20 bg-red-500/10 p-3 text-red-400 animate-shake">
        ...
        <button
          type="submit"
          className="group relative flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-violet-500/10 transition hover:from-violet-500 hover:to-indigo-500 active:scale-[0.99] duration-150"
        >
          <Sparkles className="h-4 w-4 text-emerald-400 animate-pulse group-hover:scale-110 duration-250" />
